...
async function getCategorias() {
    const requisicao = await fetch("http://localhost/cafeteria_api/categorias")
...
async function  postCategorias() {
    var requisicao = await fetch("http://localhost/cafeteria_api/categorias/",{
        method: "POST",
...
async function deleteCategoria(id) {
    var requisicao = await fetch("http://localhost/cafeteria_api/categorias/" + id,{
        method: "DELETE"  
    })
